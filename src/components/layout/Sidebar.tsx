...
export default function Sidebar({ isOpen, onClose, onToggle, isCollapsed = false }: SidebarProps) {
  ...
  return (
    <>
      ...
      <motion.button
        onClick={onToggle}
        className="hidden lg:flex fixed top-1/2 -translate-y-1/2 w-6 h-14 bg-nexpo-bg-sidebar text-white rounded-tr-full rounded-br-full shadow-md hover:shadow-lg transition-colors items-center justify-center z-40"
