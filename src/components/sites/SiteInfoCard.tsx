...
interface SiteInfoCardProps {
  ...
  onUpdateTranslation: (langCode: string, field: string, value: string) => void;
  onSetActiveLang: (lang: 'en-US' | 'vi-VN') => void;
}
    ...
    <section className="bg-white rounded-lg border border-gray-200 shadow-sm">
      ...
      <div className="p-6 space-y-6">
          ...
          <div>
            ...
            {isEditing ? (
              <Select
                ...
                onValueChange={(value) => onUpdateEditData('status', value)}
              >
        ...
        <div className="space-y-4">
          ...
          {(() => {
            // Trong view mode, lấy data từ site.translations
            // Trong edit mode, lấy data từ editData.translations
            const translations = isEditing ? editData.translations : (site?.translations || []);
            const currentTranslation = translations.find((t: any) => t.languages_code === activeLang) || 
              { languages_code: activeLang, title: '', description: '' };
