...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium cursor-pointer transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-[#f1f1f1] text-primary-foreground shadow hover:bg-content-primary/90 hover:shadow-md",
        destructive:
        ...
        gradient:
          "bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 text-white shadow-lg hover:from-blue-700 hover:via-blue-800 hover:to-indigo-800 hover:shadow-xl hover:scale-[1.02]",
      },
      size: {
