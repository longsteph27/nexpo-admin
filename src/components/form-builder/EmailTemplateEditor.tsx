...
export default function EmailTemplateEditor({
  ...
  const getFieldLabel = (field: FormField): string => {
    if (Array.isArray(field.translations)) {
      const translation = field.translations.find(t => t.languages_code === 'en-US');
      return translation?.label || field.name || field.id;
    } else if (field.translations && typeof field.translations === 'object') {
      return field.translations['en-US']?.label || field.name || field.id;
    }
