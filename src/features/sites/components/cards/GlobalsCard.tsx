...
import type { FeatureSite, SiteGlobalSettings } from '../../types';
...
export default function GlobalsCard({ site }: GlobalsCardProps) {
  const globals: SiteGlobalSettings[] = site?.globals ?? [];
        ...
        {globals.length > 0 ? (
          <div className="space-y-3">
            {globals.map((globalSetting) => (
              <div key={globalSetting.id} className="p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-content-tertiary">
                        {globalSetting.description || 'No description'}
                      </p>
                    </div>
                  </div>
